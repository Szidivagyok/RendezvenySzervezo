...
import service from "@/api/locationspictureService";

// const toast = useToastStore();

//változtatás
class Item {
  constructor(id = 0, locationId = "", pictureId = "") {
    this.id = id;
...
export const useLocationPictureStore = defineStore("locations_pictures", {
  state: () => ({
    item: new Item(),
    items: [new Item()],
    loading: false,
